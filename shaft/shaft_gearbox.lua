...
function shaft_gearbox:cb_on_metadata_inventory_take(pos, listname, index, stack, player)
  ...
  meta:set_float("back_ratio", 1/(1+now_back:get_count()))
  meta:set_string("formspec", self:get_formspec(meta, 0, 0))
end
...
function shaft_gearbox:cb_deactivate(pos, meta)
  power_generators.shaft_step(self, pos, meta, nil)
end
...
local node_inactive = {
    tiles = {
        ...
        "power_generators_shaft_gearbox_moving_parts.png",
    },
  }
...
local node_active = {
    tiles = {
        ...
        "power_generators_body_steel.png",
        {
          image = "power_generators_shaft_gearbox_moving_parts_active.png",
